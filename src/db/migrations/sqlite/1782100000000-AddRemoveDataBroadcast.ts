...
export class AddRemoveDataBroadcast1782100000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "rule" ADD "removeDataBroadcast" boolean NOT NULL DEFAULT (0)`);
        await queryRunner.query(`ALTER TABLE "reserve" ADD "removeDataBroadcast" boolean NOT NULL DEFAULT (0)`);
    }
